...
void D3DApp::OnResize()
{
	...
	CD3DX12_HEAP_PROPERTIES depthStencilHeapProp =
	...
	md3dDevice->CreateDepthStencilView(mDepthStencilBuffer.Get(), &dsvDesc,
		DepthStencilView());
	CD3DX12_RESOURCE_BARRIER depthStencilBarrierTransition = CD3DX12_RESOURCE_BARRIER::Transition(
		mDepthStencilBuffer.Get(), D3D12_RESOURCE_STATE_COMMON, D3D12_RESOURCE_STATE_DEPTH_WRITE);
	mCommandList->ResourceBarrier(1, &depthStencilBarrierTransition);
...
#if defined(DEBUG) || defined(_DEBUG)
{
	...
	D3D12_FEATURE_DATA_D3D12_OPTIONS1 waveIntrinsic = {};
	ThrowIfFailed(md3dDevice->CheckFeatureSupport(
		D3D12_FEATURE_D3D12_OPTIONS1,
		&waveIntrinsic,
		sizeof(waveIntrinsic)));
